...
# This code runs the prediction for all the pairs from class-1 
...
nglass = len(pairs_df['conf'].drop_duplicates())
print('\n*** Found {} glasses and a total of {} pairs\n\nStarting predictions'.format(nglass, len(pairs_df)))
